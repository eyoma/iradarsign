...
export const OrganisationAccountLinkConfirmationTemplate = ({
  ...
  return (
    <Html>
      <Head />
      <Preview>Confirm your organisation account link</Preview>
          ...
          <Container className="mx-auto mb-2 mt-8 max-w-xl rounded-lg border border-solid border-slate-200 px-2 pt-2 backdrop-blur-sm">
            ...
            <Section className="p-2 text-slate-500">
              <Text className="text-center text-lg font-medium text-black">
                {type === 'create' ? 'Account creation request' : 'Link your Documenso account'}
              </Text>
            ...
            <Text className="text-center text-xs text-slate-500">Link expires in 30 minutes.</Text>
          </Container>
