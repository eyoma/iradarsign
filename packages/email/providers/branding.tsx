...
export const BrandingProvider = (props: {
  ...
  const contextValue: BrandingContextValue = {
    brandingEnabled: Boolean(props.branding?.brandingEnabled) ?? defaultBrandingContextValue.brandingEnabled,
    brandingUrl: String(props.branding?.brandingUrl ?? '') ?? defaultBrandingContextValue.brandingUrl,
    brandingLogo: String(props.branding?.brandingLogo ?? '') ?? defaultBrandingContextValue.brandingLogo,
    brandingCompanyDetails:
      String(props.branding?.brandingCompanyDetails ?? '') ?? defaultBrandingContextValue.brandingCompanyDetails,
    brandingHidePoweredBy:
      Boolean(props.branding?.brandingHidePoweredBy) ?? defaultBrandingContextValue.brandingHidePoweredBy,
  };
