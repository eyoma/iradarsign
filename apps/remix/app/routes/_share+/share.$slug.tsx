...
export function meta({ params: { slug } }: Route.MetaArgs) {
  ...
  return [
    { title: 'iRadar - Share' },
    { description: 'I just signed a document in style with iRadar!' },
    {
      property: 'og:title',
      content: 'iRadar - Join the open source signing revolution',
    },
    {
      property: 'og:description',
      content: 'I just signed with iRadar!',
    },
    {
      property: 'og:type',
      content: 'website',
...
export const loader = async ({ request, params: { slug } }: Route.LoaderArgs) => {
  ...
  // Is hardcoded because this whole meta is hardcoded anyway for iRadar.
  throw redirect('https://iradarsign.com');
};
