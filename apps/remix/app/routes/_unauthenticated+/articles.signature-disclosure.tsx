  ...
  return (
    <div>
      <article className="prose dark:prose-invert">
        ...
        <p>
          <Trans>
            Thank you for using iRadar to perform your electronic document signing. The purpose of
        ...
        <p>
          <Trans>
            By proceeding to use the electronic signature service provided by iRadar, you affirm
